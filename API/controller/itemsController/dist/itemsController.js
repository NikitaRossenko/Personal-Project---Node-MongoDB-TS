...
exports.addStarship = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, starshipName = _a.starshipName, starshipModel = _a.starshipModel, starshipPrice = _a.starshipPrice, starshipDescription = _a.starshipDescription;
                if (!starshipName || !starshipModel || !starshipPrice || !starshipDescription)
                    throw new Error("Missing Info");
                return [4 /*yield*/, starshipModel_1.StarshipModel.create({ starshipName: starshipName, starshipModel: starshipModel, starshipPrice: starshipPrice, starshipDescription: starshipDescription })];
            case 1:
                createStarship = _b.sent();
                if (createStarship) {
...
exports.getStarships = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var starshipArray, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, starshipModel_1.StarshipModel.find({})];
            case 1:
                starshipArray = _a.sent();
